...
const gpt_guid gpt_guid_apple_apfs = {{
...
const gpt_guid gpt_guid_riscv64 = {{
  0xa6, 0x70, 0xec, 0x72, 0x74, 0xcf, 0xe6, 0x40, 0xbd, 0x49, 0x4b, 0xda, 0x08, 0xe8, 0xf2, 0x24
}};
// 60d5a7fe-8e7d-435c-b714-3dd8162144e1 Root Partition (RISC-V 32-bit)
const gpt_guid gpt_guid_riscv32 = {{
  0xfe, 0xa7, 0xd5, 0x60, 0x7d, 0x8e, 0x5c, 0x43, 0xb7, 0x14, 0x3d, 0xd8, 0x16, 0x21, 0x44, 0xe1
}};
